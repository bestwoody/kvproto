...
func (*TaskMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpp_213c1794a1d71131, []int{0}
}
...
func (*IsAliveRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpp_213c1794a1d71131, []int{1}
}
...
func (*IsAliveResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpp_213c1794a1d71131, []int{2}
}
...
type DispatchTaskRequest struct {
	...
	OtherReqs            []*DispatchTaskRequest `protobuf:"bytes,6,rep,name=other_reqs,json=otherReqs" json:"other_reqs,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (*DispatchTaskRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpp_213c1794a1d71131, []int{3}
}
...
func (m *DispatchTaskRequest) GetOtherReqs() []*DispatchTaskRequest {
	if m != nil {
		return m.OtherReqs
	}
	return nil
...
type DispatchTaskResponse struct {
	...
	OtherResps           []*DispatchTaskResponse `protobuf:"bytes,3,rep,name=other_resps,json=otherResps" json:"other_resps,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}
...
func (*DispatchTaskResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpp_213c1794a1d71131, []int{4}
}
...
func (m *DispatchTaskResponse) GetOtherResps() []*DispatchTaskResponse {
	if m != nil {
		return m.OtherResps
	}
	return nil
...
func (*CancelTaskRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpp_213c1794a1d71131, []int{5}
}
...
func (*CancelTaskResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpp_213c1794a1d71131, []int{6}
}
...
func (*EstablishMPPConnectionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpp_213c1794a1d71131, []int{7}
}
...
func (*MPPDataPacket) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpp_213c1794a1d71131, []int{8}
}
...
func (*Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_mpp_213c1794a1d71131, []int{9}
}
...
func (m *DispatchTaskRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.OtherReqs) > 0 {
		for _, msg := range m.OtherReqs {
			dAtA[i] = 0x32
			i++
			i = encodeVarintMpp(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *DispatchTaskResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.OtherResps) > 0 {
		for _, msg := range m.OtherResps {
			dAtA[i] = 0x1a
			i++
			i = encodeVarintMpp(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *DispatchTaskRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OtherReqs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OtherReqs = append(m.OtherReqs, &DispatchTaskRequest{})
			if err := m.OtherReqs[len(m.OtherReqs)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *DispatchTaskResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OtherResps", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OtherResps = append(m.OtherResps, &DispatchTaskResponse{})
			if err := m.OtherResps[len(m.OtherResps)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() { proto.RegisterFile("mpp.proto", fileDescriptor_mpp_213c1794a1d71131) }

var fileDescriptor_mpp_213c1794a1d71131 = []byte{
	// 607 bytes of a gzipped FileDescriptorProto
	,
}
